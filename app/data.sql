...
VALUES 
    ('L007', 'M001', '2024-10-28', '09:00:00', '10:30:00', 'L001', 1),
    ('L008', 'M001', '2024-10-29', '09:00:00', '10:30:00', 'L001', 1),
    ('L009', 'M002', '2024-10-30', '11:00:00', '12:30:00', 'L001', 1),
    ('L010', 'M003', '2024-10-31', '13:00:00', '14:30:00', 'L002', 2),
    ('L011', 'M004', '2024-10-28', '09:00:00', '10:30:00', 'L003', 2),
    ('L012', 'M005', '2024-10-29', '11:00:00', '12:30:00', 'L002', 3);
...
VALUES 
    ...
    INSERT INTO attendance (attendance_id, date_time, student_id, lecturer_id, module_id,status,lesson_id)
VALUES 
    (1, '2024-01-15 09:05:00', 'S1001', 'L001', 'M002',),
